...
btc_version = 1.18;
diag_log format ["Hearts and Vanilla Stuff %1.1", btc_version];
...
if (isServer) then {
	...
	btc_helo = [btc_helo_1,btc_helo_2,btc_boat_1,btc_boat_2,btc_boat_3];
...
[
	...
	"Land_Pod_Heli_Transport_04_ammo_F",0,
	"Land_Pod_Heli_Transport_04_box_F",0,
	"Land_Pod_Heli_Transport_04_fuel_F",0,
	"Land_Pod_Heli_Transport_04_repair_F",0,
...
btc_fnc_log_get_nottowable = {
    ...
    switch (true) do {
		...
		case (_tower isKindOf "Helicopter") : {["Truck_F","Tank","Plane","Helicopter","Truck","Ship"];};
