...
for "_i" from 0 to (count _locations - 1) do {
    ...
    if (_type in _cities) then {
        ...
        */
		if (_position distance getMarkerPos "safe_area_1" < 200) exitWith {};
		if (_position distance getMarkerPos "safe_area_2" < 200) exitWith {};
		if (_position distance getMarkerPos "safe_area_3" < 100) exitWith {};
		if (_position distance getMarkerPos "safe_area_4" < 100) exitWith {};
		if (_position distance getMarkerPos "safe_area_5" < 100) exitWith {};
		if (_position distance getMarkerPos "safe_area_6" < 100) exitWith {};
		if (_position distance getMarkerPos "safe_area_7" < 100) exitWith {};
		if (_position distance getMarkerPos "safe_area_8" < 100) exitWith {};
		if (_position distance getMarkerPos "safe_area_9" < 100) exitWith {};
		if (_position distance getMarkerPos "safe_area_10" < 100) exitWith {};
		if (_position distance getMarkerPos "safe_area_11" < 100) exitWith {};
		if (_position distance getMarkerPos "safe_area_12" < 100) exitWith {};
		if (_position distance getMarkerPos "safe_area_13" < 300) exitWith {};
